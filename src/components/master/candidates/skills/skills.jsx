...
// import { candidateskilldata } from "../../../../pages/master/candidates/skills/data";
// import { masterService } from "../../../../service";
// import { CaretUpOutlined, CaretDownOutlined } from "@ant-design/icons";

// export const CandidatesSkills = () => {
//   const [loading, setLoading] = useState(false);
//   const [SkillsDT, setSkillsDT] = useState(candidateskilldata);
//   const [openSkillsAdd, setOpenSkillsAdd] = useState(false);
//   const [openSkillsEdit, setOpenSkillsEdit] = useState(false);
//   const [Skills, setSkills] = useState("");
//   const [jobSkillsView, setJobSkillsView] = useState("");
...
//         setSkillsDT((prevSkills) =>
//           prevSkills.filter((skills) => skills.UniqueId !== selectedId)
//         );
//         getJobSkillsView();
//       } else {
...
//   const [tableParamsSkills, setTableParamsSkills] = useState({
//     pagination: {
//       current: 1,
...
//     setTableParamsSkills((prevParams) => ({
//       ...prevParams,
//       pagination: {
...
//     if (pageSize !== tableParamsSkills.pagination?.pageSize) {
//       setJobSkillsView([]);
//     }
...
//   const   = (record) => {
//     setSkillsEdit(record);
//     setOpenSkillsEdit(true);
//   };

//   const handleSkillsSubmit = async () => {
//     console.log("SkillsEdit value is-->", SkillsEdit);
//     if (!SkillsEdit || !SkillsEdit.UniqueId) {
//       console.error("Invalid skills edit data:", SkillsEdit);
//       return;
//     }
...
//     try {
//       const editedSkills = {
//         UniqueId: SkillsEdit.UniqueId,
//         Name: SkillsEdit.Name,
//         Status: SkillsEdit.Status,
//       };
...
//   const skillsAdd = () => {
//     setOpenSkillsAdd(true);
//   };

//   const skillsSave = () => {
//     setOpenSkillsAdd(false);
//     setOpenSkillsEdit(false);
//   };

//   const skillsEdit = async () => {
//     if (!SkillsEdit || !SkillsEdit.id) {
//       console.error("Invalid skills edit data:", SkillsEdit);
//       return;
//     }
...
//     try {
//       const editedSkills = {
//         UniqueId: SkillsEdit.id,
//         Name: SkillsEdit.Name,
//         Status: SkillsEdit.Status,
//       };

//       console.log("Updating skills:", editedSkills);
...
//       if (response?.data) {
//         setJobSkillsView((prevData) =>
//           prevData.map((item) =>
//             item.id === response.data.UniqueId
//               ? {
//                   ...item,
//                   skills: response.data.Name,
...
//       if (response.status) {
//         await getJobSkillsView(); // ✅ Ensure fresh data is fetched
//       }
...
//         setJobSkillsView(response.data.MasterFeeds);
//       }
//     } catch (error) {
...
//     setJobSkillsView((prevSkills) =>
//       prevSkills.map((skills) =>
//         skills.id === id ? { ...skills, status: newStatus } : skills
//       )
//     );
//   };
...
//     if (!jobSkillsView || jobSkillsView.length === 0) return;

//     const sortedData = [...jobSkillsView].sort((a, b) => {
//       if (order === "ascend") {
...
//         getJobSkillsView();
//         setSkillsDT((prevData) =>
//           prevData.map((skills) =>
//             skills.uniqueId === record.uniqueId
//               ? { ...skills, status: checked }
//               : skills
//           )
//         );
//       } else {
...
//     try {
//       if (editMode) {
//         await masterService.EditMasters(skillsData, "candidateSkills");
//       } else {
//         await masterService.addMasters("candidateSkills", {
...
//       setModalOpen(false);
//     } catch (error) {
//       console.error("Error saving candidateskills:", error);
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     if (record) {
//       setEditMode(true);
//       setSkillsData({ ...record });
//     } else {
//       setEditMode(false);
//       setSkillsData({ Name: "", Status: true, UniqueId: null });
//     }
//     setModalOpen(true);
//   };
...
//           dataSource={jobSkillsView} // ✅ Correct prop name
//           scroll={{ x: 600, y: "calc(100vh -  280px)", overflow: "overlay" }}
//           loading={loading}
//           pagination={tableParamsSkills.pagination}
...
//               onChange={(e) =>
//                 setSkillsData({ ...skillsData, Name: e.target.value })
//               }
//             />
//           </Form.Item>
//           <Form.Item label="Status">
//             <Switch
//               checked={skillsData.Status}
//               onChange={(checked) =>
//                 setSkillsData({ ...skillsData, Status: checked })
//               }
//             />
//           </Form.Item>
//         </Form>
...
//       >
//         <p>Are you sure you want to delete this Candidates skills?</p>
//       </Modal>
//     </>
//   );
// };
...
function CandidatesSkills(props) {
  ...
  const handleSave = async (values) => {
    ...
    try {
      if (editMode) {
        await masterService.EditMasters("candidateSkills", {
  ...
  const handleOpenModal = async (record) => {
    if (record) {
      setEditMode(true);
      const data = await masterService.detailMaster("candidateSkills", record);
      setEditData(data);
      form.setFieldsValue({
        name: data?.data?.name,
  ...
  const handleDelete = async () => {
    ...
    setLoading(true);
    try {
      const result = await masterService.deleteMaster("candidateSkills", selectedId);
      if (result?.status) {
        message.success("Deleted successfully");
...
export default CandidatesSkills;
