...
// export const CandidatesResponseTypes = () => {
//   const [loading, setLoading] = useState(false);
//   const [openCandidatesresponsetypesAdd, setOpenCandidatesresponsetypesAdd] =
//     useState(false);
//   const [openCandidatesresponsetypesEdit, setOpenCandidatesresponsetypesEdit] =
//     useState(false);
//   const [jobCandidatesresponsetypesView, setJobCandidatesresponsetypesView] =
//     useState([]);
//   const [CandidatesresponsetypesEdit, setCandidatesresponsetypesEdit] =
//     useState(null);
...
//         getJobCandidatesresponsetypesView();
//       } else {
...
//     setCandidatesresponsetypesEdit(record);
//     form.setFieldsValue({
//       Name: record.Name,
//       ResponseCategory: record.ResponseCategory,
//       Status: record.Status,
//     });
//     setOpenCandidatesresponsetypesEdit(true);
//   };

//   const handleCandidatesresponsetypesSubmit = async () => {
//     try {
//       const values = await form.validateFields();
//       setLoading(true);

//       const payload = {
//         UniqueId: CandidatesresponsetypesEdit?.UniqueId,
//         Name: values.Name,
//         ResponseCategory: values.ResponseCategory,
//         Status: values.Status,
//       };

//       const response = await masterService.EditMasters(payload, "responseType");

//       if (response.status) {
//         message.success("Updated successfully");
//         getJobCandidatesresponsetypesView();
//         setOpenCandidatesresponsetypesEdit(false);
//       } else {
//         message.error("Failed to update response type");
//       }
//     } catch (error) {
//       console.error("Error updating response type:", error);
//       message.error("An error occurred while updating the response type");
//     } finally {
//       setLoading(false);
//     }
//   };

//   const candidatesresponsetypesAdd = () => {
//     form.resetFields();
//     setOpenCandidatesresponsetypesAdd(true);
//   };

//   const candidatesresponsetypesSave = () => {
//     setOpenCandidatesresponsetypesAdd(false);
//     setOpenCandidatesresponsetypesEdit(false);
//   };
...
//       const response = await masterService.addMasters("responseType", payload);
...
//         form.resetFields();
//       } else {
//         message.error("Failed to add response type");
//       }
//     } catch (error) {
//       console.error("Error adding response type:", error);
//       message.error("An error occurred while adding the response type");
//     } finally {
//       setLoading(false);
//     }
//   };

//   const getJobCandidatesresponsetypesView = async (page = 1, pageSize = 10) => {
//     setLoading(true);
//     try {
...
//         setJobCandidatesresponsetypesView(response.data.MasterFeeds);
//         setTableParams({
//           ...tableParams,
//           pagination: {
...
//       },
//     });
//     getJobCandidatesresponsetypesView(pagination.current, pagination.pageSize);
//   };
...
//     if (
//       !jobCandidatesresponsetypesView ||
//       jobCandidatesresponsetypesView.length === 0
//     )
//       return;

//     const sortedData = [...jobCandidatesresponsetypesView].sort((a, b) => {
//       if (order === "ascend") {
...
//     setJobCandidatesresponsetypesView(sortedData);
//   };
...
//   const candidatesresponsetypescolumns = [
//     {
//       key: "1",
//       dataIndex: "Name",
//       title: () => (
...
//               Candidates
//             </Breadcrumb.Item>
//             <Breadcrumb.Item>Response Types</Breadcrumb.Item>
//           </Breadcrumb>
//           <div>
...
//                   type="primary"
//                   size="small"
//                   onClick={candidatesresponsetypesAdd}
//                 >
//                   Add
//                 </Button>
//               </div>
...
//         <Table
//           columns={candidatesresponsetypescolumns}
//           dataSource={jobCandidatesresponsetypesView}
...
//       <Modal
//         open={openCandidatesresponsetypesAdd}
//         title="Add "
//         centered
//         onCancel={candidatesresponsetypesSave}
//         footer={null}
//       >
//         <Form form={form} layout="vertical" onFinish={handleAddFormSubmit}>
//           <Form.Item label="Response Category" name="ResponseCategory">
//             <Select
//               size="large"
//               showSearch
...
//           <Form.Item label="Response Type" name="Name">
//             <Input type="text" size="large" placeholder="Enter Response Type" />
//           </Form.Item>
...
//             <Button
//               key="cancel"
//               onClick={candidatesresponsetypesSave}
//               style={{
//                 margin: "10px",
//               }}
//             >
...
//       <Modal
//         open={openCandidatesresponsetypesEdit}
//         title="Edit"
//         centered
//         onCancel={candidatesresponsetypesSave}
//         footer={[
//           <Button key="cancel" onClick={candidatesresponsetypesSave}>
//             Cancel
//           </Button>,
//           <Button
//             key="submit"
//             type="primary"
//             loading={loading}
//             onClick={handleCandidatesresponsetypesSubmit}
//           >
//             Update
//           </Button>,
//         ]}
...
//           form={form}
//           layout="vertical"
//           onFinish={handleCandidatesresponsetypesSubmit}
//         >
//           <Form.Item label="Response Category" name="Response Category">
//             <Select
//               size="large"
//               showSearch
//               placeholder="Select Response Category"
...
//         ]}
//       >
//         <p>Are you sure you want to delete this response type?</p>
//       </Modal>
//     </>
//   );
// };
...
function CandidatesResponseTypes(props) {
  const [form] = Form.useForm();
  ...
  const handleSave = async (values) => {
    ...
    try {
      if (editMode) {
        await masterService.EditMasters("responseType", {
          name: values && values?.name,
          status: values && values?.status,
          uniqueId: editData && editData.data.uniqueId
        });
      } else {
        await masterService.addMasters("responseType", {
          name: values && values?.name,
  ...
  const handleOpenModal = async (record) => {
    if (record) {
      setEditMode(true);
      const data = await masterService.detailMaster("responseType", record);
      setEditData(data);
      form.setFieldsValue({
        name: data?.data?.name,
  ...
  const handleDelete = async () => {
    ...
    setLoading(true);
    try {
      const result = await masterService.deleteMaster("responseType", selectedId);
      if (result?.status) {
        message.success("Deleted successfully");
          ...
          <div className="row">
            <div className='col-lg-12'>
              ...
              >
                <Input
                  size="large"
                  placeholder="Enter response types"
                />
              </Form.Item>
            </div>
            <div className='col-lg-12'>
...
export default CandidatesResponseTypes;
