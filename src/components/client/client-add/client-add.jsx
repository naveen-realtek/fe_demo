...
import { Breadcrumb, Button, Form, Input, Space, Select, Switch, notification, ConfigProvider, Upload, message } from 'antd';
...
export const ClientAdd = () => {
    ...
    const editCientEditMode = editCient && editCient.isEditModeStatus ? editCient.isEditModeStatus : false;
    ...
    function clientAdd(values) {
        let clientAdd = {
            ...
            clientName: values.clientName
                ? values.clientName
                : "",
            clientNameShort: values.clientNameShort
                ? values.clientNameShort
                : "",
    ...
    const onFinish = async (values) => {
        ...
        try {
            ...
            if (editCientEditMode) {
                response = await ClientService.editClient(editCientData && editCientData._id, clientData);
                message.success(response && response.data);
            } else {
            ...
            console.log(error);
            message.error(editCientEditMode ? "Failed to update client" : "Failed to add client");
        } finally {
            setloading(false);
        }
    };
